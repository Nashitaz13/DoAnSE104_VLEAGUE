    ...
    *, session: Session, matran: str, maclb: Optional[str] = None
    ...
    for entry, player, soaothidau, maclb_row in lineup_rows:
        ...
        detail = LineupPlayerDetail(
            ...
            maclb=maclb_row,  # Include club ID for frontend filtering
            vitri=entry.vitri,
...
def compute_standings(
    *,
    ...
    # Get all matches with results (ORDER BY datetime for correct form)
    ...
    stats = defaultdict(lambda: {
        ...
        "goals_against": 0,
        "points": 0,
        "form": []  # Chronologically ordered match results
    })
